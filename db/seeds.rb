...
#  ])
taxes = Tax.create(
  [{:name => 'SGST@2.5%', :percentage => 2.5},{:name => 'CGST@2.5%', :percentage => 2.5},
  {:name => 'SGST@6%', :percentage => 6},{:name => 'CGST@6%', :percentage => 6},
  {:name => 'SGST@9%', :percentage => 9},{:name => 'CGST@9%', :percentage => 9},
  {:name => 'SGST@14%', :percentage => 14},{:name => 'CGST@14%', :percentage => 14}]
  )
tax1,tax2 = taxes.first.id,taxes.second.id
#
items = Item.create([{
     :item_name => 'Item 1',
...
sample_currencies = [{id: 1, title: "Indian Rupee", code: "₹", unit: "INR"}]
...
u.password = "@bindu123"
u.password_confirmation = "@bindu123"
u.user_name = "admin_shri"
